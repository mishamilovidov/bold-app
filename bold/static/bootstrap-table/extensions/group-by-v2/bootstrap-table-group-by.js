    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        if ((this.options.groupBy) && (this.options.groupByField !== '')) {
            ...
            tableGroups.forEach(function(item){
                ...
                html.push(sprintf('<tr class="budget groupBy expanded" data-group-index="%s"><i class="fa fa-chevron-down" aria-hidden="true"></i>', item.id));
                ...
                that.$body.find('tr[data-parent-index='+item.id+']:last').after(drawTotalRow(item.data));
            });
            var $tr = $(drawTotalRow(Globals.budgetdataformatted));
            $tr.addClass('totalbudget');
            that.$body.append($tr);
            this.$selectGroup = [];
